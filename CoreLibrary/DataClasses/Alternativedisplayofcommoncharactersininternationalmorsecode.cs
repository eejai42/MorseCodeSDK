...
{                   
    ...
    {
        public Alternativedisplayofcommoncharactersininternationalmorsecode()
        {
            this.InitPoco();
        }
        ...
        {
            return String.Format("Alternativedisplayofcommoncharactersininternationalmorsecode: {0}", this.Name);
        }
    }
}