...
{                   
    ...
    {
        public Uploadwikimediaorgwikipediacommonsthumbfsossvgpxsossvgpng()
        {
            this.InitPoco();
        }
        ...
        {
            return String.Format("Uploadwikimediaorgwikipediacommonsthumbfsossvgpxsossvgpng: {0}", this.Name);
        }
    }
}